    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            AI-powered CSV cleaning that removes duplicates, fixes formats, and improves data quality. 
            Start cleaning immediately - no signup required for your first 3 files.
          </p>
          <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose CleanMyCSV?</h2>
          <p className="text-lg text-gray-600">Powerful features to make your data work better</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl p-8 shadow-lg">
            ...
            <p className="text-gray-600">Clean files in seconds, not hours. Our optimized engine handles large datasets efficiently.</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            ...
            <p className="text-gray-600">Smart column detection and natural language instructions make cleaning intuitive and accurate.</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            ...
            <p className="text-gray-600">Your data never leaves our secure servers. Files are automatically deleted after processing.</p>
          </div>
        </div>
      </div>
